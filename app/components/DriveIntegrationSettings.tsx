...
export function DriveIntegrationSettings() {
  ...
  return <section className="drive-settings panel">
    <div className="panel-head"><div><p className="eyebrow">INTEGRAÇÃO</p><h2>Google Drive</h2><p>Estrutura preparada para OAuth, upload direto, sincronização e miniaturas.</p></div><span className="integration-status pending">Preparação</span></div>
    ...
    <p className="settings-note">Os botões serão habilitados após configurar GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET e GOOGLE_REDIRECT_URI no ambiente de produção.</p>
  </section>;
}
