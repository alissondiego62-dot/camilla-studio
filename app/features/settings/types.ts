...
export type WorkflowRow={id:string;code:string;name:string;color:string|null;position:number;active:boolean;final:boolean;archived_at:string|null;linked_records?:number};
