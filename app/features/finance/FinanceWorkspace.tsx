...
import { FinanceCancelDialog } from "./FinanceCancelDialog";
...
export function FinanceWorkspace(){
 ...
 return <ModuleFrame title="Financeiro" subtitle="Gestão financeira profissional do escritório">
  ...
  <FeedbackMessage error={workspace.action.error} success={workspace.action.success}/>{workspace.error&&<ErrorState message={workspace.error} onRetry={()=>void workspace.reload()}/>} {workspace.loading?<LoadingState/>:<>
   ...
   {workspace.section==="revenue"&&<FinanceRevenue items={workspace.visibleEntries} canViewValues={workspace.canViewValues} canSettle={workspace.canSettle} onOpen={openEntry} onSettle={workspace.setPaymentEntry} canCancel={canCancel} onCancel={workspace.setCancelEntry} canDelete={canArchive} onDelete={workspace.setDeleteEntry}/>} 
   {workspace.section==="expenses"&&<FinanceExpenses items={workspace.visibleEntries} canViewValues={workspace.canViewValues} canSettle={workspace.canSettle} onOpen={openEntry} onSettle={workspace.setPaymentEntry} canCancel={canCancel} onCancel={workspace.setCancelEntry} canDelete={canArchive} onDelete={workspace.setDeleteEntry}/>} 
  ...
  {workspace.cancelEntry&&<FinanceCancelDialog entry={workspace.cancelEntry} canViewValues={workspace.canViewValues} pending={workspace.action.pending} onClose={()=>workspace.setCancelEntry(null)} onConfirm={(reason)=>void workspace.cancel(workspace.cancelEntry!.id,reason)}/>}
