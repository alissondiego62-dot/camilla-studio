...
-- Cancelamento seguro: lançamentos liquidados são estornados atomicamente antes do cancelamento.
...
-- Repara cancelamentos antigos que deixaram baixas ativas e saldos inconsistentes.
do $$
...
values('3.0.21','Etapa 19.1: cancelamento seguro de receitas e despesas liquidadas com estorno atômico de baixas e ajustes; Etapa 19: receitas previstas sem data, separação do contas a receber com e sem vencimento, saldo bancário real, recebimentos no período, liquidação dentro do projeto e exclusão financeira segura.','production')
